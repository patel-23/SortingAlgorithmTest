...
public class FewUniqueValues {
	...
	public static void main(String[] args) {
		...
		// Bubble sort with a few unique values
		for (int i = 0; i < 10; i++) {

			int arr[] = a.fewUniqueArray(10);
			timer.start();
		...
		for (int i = 0; i < 10; i++) {
			...
			int arr[] = a.fewUniqueArray(10000);
			timer.start();
			sorter.bubbleSort(arr);
			timer.stop();
			results[i] = timer.getElapsedTime();
		...
		for (int i = 0; i < 10; i++) {
			...
			int arr[] = a.fewUniqueArray(100000);
			timer.start();
			sorter.bubbleSort(arr);
			timer.stop();
			results[i] = timer.getElapsedTime();
		...
		// Selection sort with a few unique values
		...
		// Insertion sort with a few unique values
		...
		// Merge sort with a few unique values
		...
		// Quick sort with a few unique values
