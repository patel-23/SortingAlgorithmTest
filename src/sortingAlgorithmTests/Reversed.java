...
public class Reversed {
	...
	public static void main(String[] args) {
		...
		// Bubble sort with reversed data
		for (int i = 0; i < 10; i++) {

			int arr[] = a.reversedArray(10);
			timer.start();
		...
		for (int i = 0; i < 10; i++) {
			...
			int arr[] = a.reversedArray(100000);
			timer.start();
			sorter.bubbleSort(arr);
			timer.stop();
			results[i] = timer.getElapsedTime();
		...
		// Selection sort with reversed data
		...
		// Insertion sort with reversed data
